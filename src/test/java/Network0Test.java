...
class Network0Test {
    ...
    void testNotValid(String input) {
        assertThrows(ParseException.class, ()->{new Network0(input);});
    }
    ...
    void testList(String input) throws ParseException {
        ...
        assertEquals(new ArrayList<>(sorted), new Network0(input).list());
    }
    ...
    void testConnect() throws ParseException {
        ...
        assertFalse(new Network0(input).connect(new IP("34.49.145.239"), new IP("231.189.0.127")));
    }

    @Test
    void testDisconnect() throws ParseException {
        String input = "(85.193.148.81 141.255.1.133 34.49.145.239 231.189.0.127)";
        final Network0 ntwGraph = new Network0(input);
    ...
    void testContains() throws ParseException {
        String input = "(85.193.148.81 141.255.1.133 34.49.145.239 231.189.0.127)";
        final Network0 network = new Network0(input);
    ...
    void testGetHeight() throws ParseException {
        ...
        Network0 network = new Network0(input);
    ...
    void testCalcEdges() throws ParseException {
        String input = "(85.193.148.81 (141.255.1.133 122.117.67.158 0.146.197.108) 34.49.145.239 (231.189.0.127 77.135.84.171 39.20.222.120 252.29.23.0 116.132.83.77))";
        System.out.println(Network0.calcEdges(input));
    }
    ...
    void testAddExistingSubnet() throws ParseException {
        ...
        assertFalse(new Network0(network).add(new Network0(subnet)));
    }
    ...
    void testAddShapesACycle() throws ParseException {
        ...
        final Network0 network = new Network0(networkString);
        final Network0 subnetwork = new Network0(subNetwork);
    ...
    void testAddSuccess() throws ParseException {
        ...
        final Network0 network = new Network0(networkStr);
        final Network0 subnetwork = new Network0(subNetworkStr);
    ...
    void testAddMerge() throws ParseException {
        Network0 network = new Network0( "(122.117.67.158 (141.255.1.133 0.146.197.108))");
        Network0 subnetwork = new Network0("(85.193.148.81 34.49.145.239 231.189.0.127 141.255.1.133)");
